...
public class MainForm : Form {
    ...
    public MainForm() {
        ...
        tabRecurring.BackColor = BgColor;
        // 把 todoApp 傳給排程模組，讓它可以直接把任務塞進去
    ...
    protected override void WndProc(ref Message m) {
        ...
        if (isPositionLocked) { if (m.Msg == WM_SYSCOMMAND && (m.WParam.ToInt32() & 0xfff0) == SC_MOVE) return; if (m.Msg == WM_NCLBUTTONDOWN && m.WParam.ToInt32() == HTCAPTION) return; }
        base.WndProc(ref m);
    }
