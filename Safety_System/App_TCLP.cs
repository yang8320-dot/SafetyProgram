...
namespace Safety_System
{
    public class App_TCLP
    {
        ...
        private const string TableName = "TCLP"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [TCLP] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"TCLP 毒性特性溶出程序數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
