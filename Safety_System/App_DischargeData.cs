/// FILE: Safety_System/App_DischargeData.cs ///
using System;
using System.Data;
...
namespace Safety_System
{
    public class App_DischargeData
    {
        ...
        public Control GetView()
        {
            ...
            GroupBox boxTop = new GroupBox { Text = $"【月】納管水質排放數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
