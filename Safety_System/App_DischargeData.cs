...
namespace Safety_System
{
    public class App_DischargeData
    {
        ...
        private void BtnExport_Click(object sender, EventArgs e) {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog { Filter = "Excel 活頁簿 (*.xlsx)|*.xlsx|CSV 檔案 (*.csv)|*.csv", FileName = "納管水質排放數據_" + DateTime.Now.ToString("yyyyMMdd") }) {
