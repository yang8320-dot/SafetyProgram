...
{
    public class App_CoolingWaterVendor
    {
        ...
        private const string TableName = "CoolingWaterVendor"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [CoolingWaterVendor] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"循環水檢測數據_廠商 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
