...
{
    public class App_WastewaterSelfTest
    {
        ...
        private const string TableName = "WastewaterSelfTest"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [WastewaterSelfTest] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"廢水自主檢驗數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
