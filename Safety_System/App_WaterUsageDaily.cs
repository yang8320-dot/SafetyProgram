...
namespace Safety_System
{
    public class App_WaterUsageDaily
    {
        ...
        private const string TableName = "WaterUsageDaily"; // 🟢 獨立新資料表
        ...
        public Control GetView()
        {
            ...
            GroupBox boxTop = new GroupBox { Text = $"【日】自來水使用量 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
            ...
            // 🟢 實例化全域運算共用 Helper，負責處理日統計與星期自動更新
        ...
        private void BtnExport_Click(object sender, EventArgs e) {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog { Filter = "Excel 活頁簿 (*.xlsx)|*.xlsx|CSV 檔案 (*.csv)|*.csv", FileName = "自來水使用量記錄_" + DateTime.Now.ToString("yyyyMMdd") }) {
