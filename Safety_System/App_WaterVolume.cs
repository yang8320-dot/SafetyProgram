...
namespace Safety_System
{
    public class App_WaterVolume
    {
        ...
        public Control GetView()
        {
            ...
            GroupBox box = new GroupBox { Text = "自來水用水量統計 (庫: Water)", Dock = DockStyle.Fill, Font = new Font("UI", 12F), AutoSize = true };
            ...
            flp.Controls.AddRange(new Control[] { _dtpStart, _dtpEnd, bRead, bSave });
