...
namespace Safety_System
{
    public static class TableSchemaManager
    {
        ...
        public static readonly Dictionary<string, string> SchemaMap = new Dictionary<string, string>
        {
			...
			//檢測數據
			//環境監測
			{ "EnvMonitor", "[日期] TEXT, [時間] TEXT, [SEG編號] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//廢水定申檢
            { "WastewaterPeriodic", "[日期] TEXT, [時間] TEXT, [申報季別] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//飲用水
            { "DrinkingWater", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//工業區
            { "IndustrialZoneTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//土壤氣
            { "SoilGasTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//廢水自主
            { "WastewaterSelfTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//循環水(廠商)
            { "CoolingWaterVendor", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//循環水(自評)
            { "CoolingWaterSelf", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//TCLP
            { "TCLP", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//水錶校正
