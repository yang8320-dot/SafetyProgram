...
namespace Safety_System
{
    public static class TableSchemaManager
    {
        ...
        public static readonly Dictionary<string, string> SchemaMap = new Dictionary<string, string>
        {
            ...
            // 🟢 新增：員工健康關懷 Schema
            { "EmployeeHealthCare", "[年月] TEXT, [基本關懷人數] TEXT, [臨時關懷人數] TEXT, [關懷人數小計] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			...
			//檢測數據
			//環境監測
			{ "EnvMonitor", "[日期] TEXT, [時間] TEXT, [SEG編號] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//廢水定申檢
            { "WastewaterPeriodic", "[日期] TEXT, [時間] TEXT, [申報季別] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//飲用水
            { "DrinkingWater", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//工業區
            { "IndustrialZoneTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//土壤氣
            { "SoilGasTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//廢水自主
            { "WastewaterSelfTest", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//循環水(廠商)
            { "CoolingWaterVendor", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//循環水(自評)
            { "CoolingWaterSelf", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//TCLP
            { "TCLP", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [檢測項目] TEXT, [檢測數據] TEXT, [管制值] TEXT, [測定方法] TEXT, [檢驗機構] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//水表校正
            { "WaterMeterCalibration", "[日期] TEXT, [時間] TEXT, [檢測點] TEXT, [水表名稱] TEXT, [管制值] TEXT, [管徑] TEXT, [現場流量計讀值] TEXT, [檢驗單位讀值] TEXT, [器差值] TEXT, [設定參數K值] TEXT, [校正單位] TEXT, [下次校正日期] TEXT, [測定用途] TEXT, [符合度] TEXT, [附件檔案] TEXT, [備註] TEXT" },
			//其它檢測
            ...
            // 個人隱藏選單
            { "WorkItems", "[日期] TEXT, [類別] TEXT, [內容說明] TEXT, [如何執行] TEXT, [狀況追蹤] TEXT, [完成日期] TEXT, [附件檔案] TEXT, [備註] TEXT" }
        };
