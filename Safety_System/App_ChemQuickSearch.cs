...
namespace Safety_System
{
    public class App_ChemQuickSearch
    {
        ...
        public Control GetView()
        {
            ...
            Button btnPdf = new Button { Text = "📄 導出 PDF 報表", Size = new Size(200, 40), BackColor = Color.IndianRed, ForeColor = Color.White, Font = new Font("Microsoft JhengHei UI", 12F, FontStyle.Bold), Cursor = Cursors.Hand };
