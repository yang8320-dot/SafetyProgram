...
namespace Safety_System
{
    public class App_HazardStats
    {
        ...
        private const string TableName = "HazardStats"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [HazardStats] (
            ...
            GroupBox box = new GroupBox { Text = "公共危險物品統計表 (庫: Fire)", Dock = DockStyle.Fill, Font = new Font("UI", 12F), AutoSize = true };
            ...
            flp.Controls.AddRange(new Control[] { new Label { Text = "統計日期:" }, _dtpStart, _dtpEnd, bRead, bSave });
