...
namespace Safety_System
{
    public class App_OtherTests
    {
        ...
        private const string TableName = "OtherTests"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [OtherTests] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"其它檢測數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
