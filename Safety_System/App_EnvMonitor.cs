...
namespace Safety_System
{
    public class App_EnvMonitor
    {
        ...
        private const string TableName = "EnvMonitor"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [EnvMonitor] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"環境監測數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
