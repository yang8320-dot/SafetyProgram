...
{
    public class App_DrinkingWater
    {
        ...
        private const string TableName = "DrinkingWater"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [DrinkingWater] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"飲用水檢測數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
