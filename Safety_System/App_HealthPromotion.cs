...
namespace Safety_System
{
    public class App_HealthPromotion
    {
        ...
        private const string TableName = "HealthPromotion"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [HealthPromotion] (
            ...
            GroupBox box = new GroupBox { Text = "健康促進活動 (庫: " + DbName + ")", Dock = DockStyle.Fill, Font = new Font("UI", 12F), AutoSize = true };
            ...
            flp.Controls.AddRange(new Control[] { new Label { Text = "活動日期:" }, _dtpStart, _dtpEnd, bRead, bSave });
