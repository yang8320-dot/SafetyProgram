...
namespace Safety_System
{
    public class App_WaterReport
    {
        public Control GetView()
        {
            ...
            Label t = new Label { Text = "💧 用水申報看板 (開發中)", Font = new Font("Microsoft JhengHei UI", 24F, FontStyle.Bold), AutoSize = true, Location = new Point(30, 20) };
            p.Controls.Add(t);
            main.Controls.Add(p);
            return main;
        }
