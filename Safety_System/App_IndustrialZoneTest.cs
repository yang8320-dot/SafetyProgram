...
{
    public class App_IndustrialZoneTest
    {
        ...
        private const string TableName = "IndustrialZoneTest"; 

        public Control GetView()
        {
            DataManager.InitTable(DbName, TableName, @"CREATE TABLE IF NOT EXISTS [IndustrialZoneTest] (
            ...
            GroupBox boxTop = new GroupBox { Text = $"工業區檢驗數據 (庫：{DbName} 表：{TableName})", Dock = DockStyle.Fill, Font = new Font("Microsoft JhengHei UI", 12F), AutoSize = true, Padding = new Padding(10, 15, 10, 10) };
